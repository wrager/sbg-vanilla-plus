...
| --------------------------------- | -------------------- | -------- | ----------------------------------------------------------------------- |
| Улучшенный интерфейс попапа точки | enhancedPointPopupUi | Style    | Увеличенные кнопки на экране точки для удобства на мобильных            |
...
| Рисование всегда доступно         | drawAlwaysAvailable  | Features | Кнопка Draw всегда активна — исправляет баг игры, когда кнопка зависает |
| Экран не гаснет                   | keepScreenOn         | Features | Экран не гаснет во время игры (Wake Lock API)                           |
| Сдвиг центра карты вниз           | shiftMapCenterDown   | Style    | Сдвигает центр карты вниз, чтобы видеть больше карты впереди            |
