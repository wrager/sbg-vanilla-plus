...
| --------------------------------- | -------- | ----------------------------------------------------------------------- |
| Улучшенный интерфейс попапа точки | Style    | Увеличенные кнопки на экране точки для удобства на мобильных            |
| Отключение зума по двойному тапу  | Features | Отключает зум по двойному тапу для предотвращения случайного зума       |
| Рисование всегда доступно         | Features | Кнопка Draw всегда активна — исправляет баг игры, когда кнопка зависает |
| Экран не гаснет                   | Features | Экран не гаснет во время игры (Wake Lock API)                           |
| Сдвиг центра карты вниз           | Features | Сдвигает центр карты вниз, чтобы видеть больше карты впереди            |
