...
export const favoritesMigration: IFeatureModule = {
  ...
  description: {
    en: 'Migrates the local SVP/CUI favorited points list into native stars or locks',
    ru: 'Переносит локальный список избранных точек SVP/CUI в нативные «звёздочки» или «замочки»',
  },
  defaultEnabled: true,
  category: 'feature',
