 ...
 * Slash рисуется двумя линиями: тёмный контур (читаемость поверх лучей) + линия
 * текущего цвета. Линия выходит за границы иконки (от -2 до 26) и толще самих
 * лучей (~5px для внутренней линии при 24-unit viewBox), чтобы не путалась
 * с одним из лучей asterisk и читалась как отдельный элемент.
 */
