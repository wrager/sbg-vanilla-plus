...
| Только защита locked    | «Скрыты последние N ключей от защищённых точек»                    | «Скрыто: N точек с замочком»                                |
| Звезда + дистанция      | «Точки (N) скрыты: "Звезда" + ограничение дальности»               | «Точки (N) скрыты: "Звезда" + ограничение дальности»        |
| Звезда + защита locked  | «Скрыто: N в режиме "Звезда", последние M ключей защищённых точек» | «Скрыто: N в режиме "Звезда", M точек с замочком»           |
