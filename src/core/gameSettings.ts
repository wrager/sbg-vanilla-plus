 ...
 * настройки. У игрока, ни разу не заходившего в настройки, ключа нет, но
 * игра при этом ведёт себя по своим дефолтам - значит и мы должны.
 *
 ...
 *
 * Дублируется только нужное подмножество: полный объект (20 полей,
